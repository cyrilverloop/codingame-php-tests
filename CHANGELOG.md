...
- symfony/string v8.0.8 => v8.1.0.
- symfony/translation-contracts v3.6.1 => v3.7.0.
- twig/twig v3.24.0 => v3.27.1.
- cyril-verloop/codingame-configuration 1.26.0 => 1.27.0.
...
## [6.16.0] - 2026-03-31
### Changed
- cyril-verloop/codingame-configuration 1.24.0 => 1.25.0.
- twig/string-extra v3.23.0 => v3.24.0.
- twig/twig v3.23.0 => v3.24.0.
- phpunit 13.0.5 => 13.0.6.
- psalm 6.15.1 => 6.16.1.

## [6.15.0] - 2026-02-28
### Changed
- phpunit 12.5.8 => 13.0.5.
- psalm 6.15.0 => 6.15.1.
- symfony/string v8.0.4 => v8.0.5.
- cyril-verloop/codingame-configuration 1.23.0 => 1.24.0.
...
- psalm 6.14.3 => 6.15.0.
- cyril-verloop/codingame-configuration 1.22.0 => 1.23.0.
